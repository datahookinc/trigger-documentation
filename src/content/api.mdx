...
<mark>**Note**: The **TableEntry\<T\>** type represents your table type with the added "_\_pk_" property. So, if your table type is **\{ customer: string \}**, then the corresponding **TableEntry\<T\>** type is **\{ _pk: number, customer: string\}**</mark>

<br />
<br />

<mark>**Note**: The **Partial\<T\>** type represents your table type with all properties set to optional. This allows you pass the properties most relevant for your query**</mark>
...
<mark>**Note**: PK means **primary key**, which is the "_\_pk_" property automatically set for each record in your table.</mark>
