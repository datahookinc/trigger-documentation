...
To use your <span class="inline-code">queue</span> in your application, you simply import the <span class="inline-code">queues</span> value and use the namespaced queue name:
