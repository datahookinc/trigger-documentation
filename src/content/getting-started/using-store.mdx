...
Trigger uses React hooks internally, which makes it easy to integrate the store into your application. In the above example, we simply need to import the <span class="inline-code">tables</span> property from our store which
