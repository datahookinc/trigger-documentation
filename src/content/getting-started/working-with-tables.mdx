...
Your tables are made up of **rows**. Each row can have columns (or attributes) that use any of the basic types listed above. Besides these basic types, your tables can also use:
